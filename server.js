...
async function initDB() {
  await pool.query(`
    ...
    CREATE TABLE IF NOT EXISTS agent_intent_rules (
      id SERIAL PRIMARY KEY,
      agent_id INT REFERENCES sales_agents(id) ON DELETE CASCADE,
    ...
    CREATE TABLE IF NOT EXISTS conversation_memories (
      id SERIAL PRIMARY KEY,
      lead_id INT NOT NULL REFERENCES hotel_leads(id) ON DELETE CASCADE,
      agent_id INT NOT NULL REFERENCES sales_agents(id) ON DELETE CASCADE,
      summary TEXT,
      current_stage VARCHAR(80),
      lead_score INT DEFAULT 0,
      pain_points JSON DEFAULT '[]',
      interested_features JSON DEFAULT '[]',
    ...
    CREATE INDEX IF NOT EXISTS idx_campaign_agent ON campaigns(agent_id);
    CREATE INDEX IF NOT EXISTS idx_agent_knowledge_scope ON agent_knowledge(agent_id, active, priority DESC);
    CREATE INDEX IF NOT EXISTS idx_conversation_memories_lead ON conversation_memories(lead_id);
...
app.use('/api/sales-agents', require('./routes/salesAgents'));
